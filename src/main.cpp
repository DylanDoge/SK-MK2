...
void setup()
{
    ...
    const unsigned int pinCount = 7;
    const unsigned int pins[pinCount] = {RotaryA, RotaryB, playPauseSwitch, nextSwitch, prevSwitch, shuffleSwitch, likeSwitch};
